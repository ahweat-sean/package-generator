...
class PackageGeneratorCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'package:generator {vendor=ahweat-sean} {package=package-name} {author=Ahweat Sean} {email=ahweatsean@gmail.com} {description=package-name description.}';
     ...
     * @var string
     */
    protected $description = 'Generate a package from ahweat-sean/package-generator repository';
